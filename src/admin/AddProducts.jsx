...
const AddProducts = () => {
  ...
  const [enterProuctImg, setEnterProuctImg] = useState(null);
  ...
  const addProduct = async(e)=>{
    ...
    try {
      ...
      const storageRef = ref(storage, `productImages/${Date.now() + enterProuctImg.name}`);

      const uploadTask = uploadBytesResumable(storageRef, enterProuctImg);
        ...
        <Col lg='12'>
         {
          ...
          <Form onSubmit={addProduct}>
            ...
            <FormGroup className='form_group'>
              ...
              <input type="file" onChange={e=> setEnterProuctImg(e.target.files[0])} required/>
            </FormGroup>
            </div>
